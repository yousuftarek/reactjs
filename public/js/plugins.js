  ...
  (i.fn.fakeLoader = function(c) {
    ...
    return (
      ...
      o.each(function() {
        ...
        "" != d.imagePath &&
          o.html('<div class="fl"><img src="' + d.imagePath + '"></div>'),
          s();
      }),
      setTimeout(function() {
        i(o).fadeOut();
...
(function(t, J, f, x) {
  ...
  f.extend(b, {
      ...
      if (a && (f.isPlainObject(c) || (c = {}), !1 !== b.close(!0)))
        return (
          ...
          f.each(a, function(d, e) {
            ...
            !n &&
              k.isDom &&
              ((n = e.data("fancybox-type")),
              n ||
                (n = (n = e.prop("class").match(/fancybox\.(\w+)/))
                  ? n[1]
                  : null));
            r(g) &&
              (n ||
            ...
            h ||
              ("inline" === n
                ? g
                  ? (h = f(r(g) ? g.replace(/.*(?=#[^\s]+$)/, "") : g))
                  : k.isDom && (h = e)
                : "html" === n
                ? (h = g)
                : n || g || !k.isDom || ((n = "inline"), (h = e)));
            f.extend(k, {
              href: g,
              type: n,
              content: h,
          ...
          c.keys !== x &&
            (b.opts.keys = c.keys ? f.extend({}, b.defaults.keys, c.keys) : !1),
          (b.group = a),
    ...
    reposition: function(a, c) {
      ...
      e &&
        ((k = b._getPosition(c)),
        a && "scroll" === a.type
          ? (delete k.position, e.stop(!0, !0).animate(k, 200))
          : (e.css(k), (d.pos = f.extend({}, d.dim, k))));
    },
    update: function(a) {
        ...
        (D = setTimeout(
          function() {
            ...
            e &&
              ...
              (d || "load" === c || ("resize" === c && e.autoResize)) &&
                b._setDimension(),
              ("scroll" === c && e.canShrink) || b.reposition(a),
              b.trigger("onUpdate"),
              (D = null));
          },
          d && !u ? 0 : 300
    ...
    getViewport: function() {
      ...
      a && a.length
        ? ((c.w = a[0].clientWidth), (c.h = a[0].clientHeight))
        : ((c.w = u && t.innerWidth ? t.innerWidth : q.width()),
          (c.h = u && t.innerHeight ? t.innerHeight : q.height()));
      return c;
    },
      ...
      a &&
          ...
          p.bind("keydown.fb", function(d) {
            ...
            d.ctrlKey ||
              ...
              f.each(c, function(c, k) {
                if (1 < a.group.length && k[e] !== x)
                  return b[c](k[e]), d.preventDefault(), !1;
        ...
        f.fn.mousewheel &&
          ...
          b.wrap.bind("mousewheel.fb", function(c, e, k, g) {
            for (
              var d = f(c.target || null), h = !1;
              d.length &&
              !(h || d.is(".fancybox-skin") || d.is(".fancybox-wrap"));

            )
              (h =
                (h = d[0]) &&
                !(h.style.overflow && "hidden" === h.style.overflow) &&
                ((h.clientWidth && h.scrollWidth > h.clientWidth) ||
                  (h.clientHeight && h.scrollHeight > h.clientHeight))),
                (d = f(d).parent());
            0 !== e &&
              !h &&
              1 < b.group.length &&
    ...
    _setDimension: function() {
        ...
        if (((I = l.content), l.autoHeight && I && 1 === I.data("ready")))
          try {
            I[0].contentWindow.document.location &&
              (g.width(E).height(9999),
              (H = I.contents().find("body")),
              r && H.css("overflow-x", "hidden"),
              (C = H.outerHeight(!0)));
          } catch (M) {}
      } else if (l.autoWidth || l.autoHeight)
      ...
      l.aspectRatio
        ? (d > p && ((d = p), (h = m(d / F))),
          ...
          d < n && ((d = n), (h = m(d / F))),
          h < w && ((h = w), (d = m(h * F))))
        : ((d = Math.max(n, Math.min(d, p))),
          l.autoHeight && "iframe" !== l.type && (g.width(d), (h = g.height())),
          (h = Math.max(w, Math.min(h, q))));
      if (l.fitToView)
        if (
          (g.width(d).height(h),
          e.width(d + z),
    ...
    _getPosition: function(a) {
      ...
      c.autoCenter && c.fixed && !a && g <= d.h && f <= d.w
        ? (e.position = "fixed")
        : c.locked || ((e.top += d.y), (e.left += d.x));
  ...
  b.transitions = {
    getOrigPosition: function() {
      ...
      !d &&
        a.isDom &&
        c.is(":visible") &&
        ((d = c.find("img:first")), d.length || (d = c));
      v(d)
        ? ((e = d.offset()),
          d.is("img") && ((f = d.outerWidth()), (g = d.outerHeight())))
        : ((e.top = n.y + (n.h - g) * a.topRatio),
          (e.left = n.x + (n.w - f) * a.leftRatio));
    ...
    zoomIn: function() {
      ...
      delete k.position;
      e
        ? ((c = this.getOrigPosition()), a.openOpacity && (c.opacity = 0.1))
        : "fade" === d && (c.opacity = 0.1);
      b.wrap
        .css(c)
        .animate(k, {
  ...
  b.helpers.overlay = {
      ...
      a.closeClick &&
        this.overlay.bind("click.overlay", function(a) {
          if (f(a.target).hasClass("fancybox-overlay"))
            return b.isActive ? b.close() : c.close(), !1;
        });
    ...
    update: function() {
      ...
      K
        ? ((b = Math.max(J.documentElement.offsetWidth, J.body.offsetWidth)),
          p.width() > b && (a = p.width()))
  ...
  f.fn.fancybox = function(a) {
    ...
    e && !1 !== a.live
      ...
      : d.unbind("click.fb-start").bind("click.fb-start", k);
          ...
          return (
            q(d) &&
              ...
              f &&
                ((d = Math.round(d)),
                (f = Le.h = Math.round(
                  h(f, p(Le.minheight, i), p(Le.maxheight, i))
                )),
